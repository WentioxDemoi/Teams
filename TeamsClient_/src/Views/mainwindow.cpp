...
void MainWindow::start() {
  ...
  connect(authView->registerForm, &RegisterForm::registerRequested, authViewModel,
          &AuthViewModel::registerUser);

  connect(authViewModel, &AuthViewModel::authSuccess, this, &MainWindow::authSuccess);

  connect(authViewModel, &AuthViewModel::authError, this,
          [](const QString& error) { qDebug() << "Error loggin : " << error; });
  connect(authViewModel, &AuthViewModel::noTokenFound, this, &MainWindow::noTokenFound);
  connect(webRTCViewModel, &WebRTCViewModel::onP2PChange, workspaceView,
          &WorkspaceView::OnP2PChange);
  // connect(workspaceView, &WorkspaceView::OnP2PChange, webRTCViewModel,
  // &WebRTCViewModel::initP2P); 
