...
public:
  ...
  MOCK_METHOD(bool, remove, (const std::string &userUuid, const std::string &contactUuid), (override));
  ...
  MOCK_METHOD(bool, update_last_read_at,
              (const std::string &userUuid, const std::string &contactUuid, const std::string &lastReadAt),
              (override));
};