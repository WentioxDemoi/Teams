...
class IContactService {
 public:
  ...
  virtual std::optional<std::string> searchUsers(const std::string &userUuid, const std::string &payload) = 0;
  virtual std::optional<std::string> resolveUserByUuid(const std::string &uuid) = 0;
  virtual std::optional<std::string> lastReadAt(const std::string &uuid, const std::string &timestamp) = 0;
  virtual std::optional<std::string> updateStatus(const std::string &userUuid, const std::string &payload) = 0;
};
