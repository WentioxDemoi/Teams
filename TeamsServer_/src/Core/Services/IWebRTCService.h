...
class IWebRTCService {
 public:
  ...
  virtual std::optional<std::string> requestCall(const std::string& callerUuid,
                                                 const std::string& targetUuid) = 0;
  ...
  virtual bool relaySignaling(const std::string& senderUuid, const std::string& targetUuid,
                              const std::string& payload) = 0;
  virtual bool cameraEnabledChange(const std::string& senderUuid, const std::string& targetUuid,
                                   const std::string& payload) = 0;
};
