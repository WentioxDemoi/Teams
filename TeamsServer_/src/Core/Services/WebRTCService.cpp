...
bool WebRTCService::relayToTarget(const std::string &senderUuid, const std::string &targetUuid, std::string payload) {
...
bool WebRTCService::acceptCall(const std::string &calleeUuid, const std::string &targetUuid) {
  return relayToTarget(calleeUuid, targetUuid, R"({"type":"call_accept"})");
}
...
bool WebRTCService::cameraEnabledChange(const std::string &senderUuid, const std::string &targetUuid,
