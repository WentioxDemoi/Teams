...
std::optional<std::string> WebRTCService::requestCall(const std::string& callerUuid,
...
bool WebRTCService::cameraEnabledChange(const std::string& senderUuid,
                                        const std::string& targetUuid, const std::string& payload) {
