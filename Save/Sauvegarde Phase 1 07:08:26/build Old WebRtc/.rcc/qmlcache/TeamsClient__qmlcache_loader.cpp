...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_TeamsClient_)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_TeamsClient_))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_TeamsClient_)() {
    return 1;
}
